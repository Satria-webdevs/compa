<x-layout>
    ...
    <div class="bg-white rounded-4 shadow-sm p-4 mb-5">
        ...
        <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-xl-8">php artisan make:model Post -m
                    <div class="mb-3">
                ...
                <div class="col-xl-4">
                    <div class="mb-3">
                        ...
                        <select name="category" class="form-select @error('category') is-invalid @enderror"
                            ...
                            <option {{ old('category') == 'Laravel' ? 'selected' : '' }} value="Laravel">Laravel
                            </option>
                            <option {{ old('category') == 'Codeigniter' ? 'selected' : '' }} value="Codeigniter">
                                Codeigniter</option>
                        </select>
