                ...
                <div class="col-xl-8">
                    <div class="mb-3">
                        ...
                        <input type="text" name="title" class="form-control @error('title') is-invalid @enderror"
                            value="{{ old('title', $product->title) }}" autocomplete="off">
                ...
                <div class="col-xl-4">
                    <div class="mb-3">
                        ...
                        <select name="category" class="form-select @error('category') is-invalid @enderror"
                            ...
                            <option {{ old('category', $product->category) == 'PHP' ? 'selected' : '' }} value="PHP">
                                PHP</option>
                            <option {{ old('category', $product->category) == 'Laravel' ? 'selected' : '' }}
                                value="Laravel">Laravel</option>
                            <option {{ old('category', $product->category) == 'Codeigniter' ? 'selected' : '' }}
                                value="Codeigniter">Codeigniter</option>
                        </select>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="mt-4">
                            <img id="imagePreview" src="{{ asset('/storage/products/' . $product->image) }}"
                                class="border img-fluid rounded-4 shadow-sm" alt="Image">
                        </div>
                    </div>
                </div>
            </div>
