            ...
            <div class="navbar-content">
                ...
                <div class="card pc-user-card mt-3">
                    <div class="card-body text-center">
                        <img src="../assets/images/application/img-coupon.png" alt="img"
                            class="img-fluid w-50" />
                        <h5 class="mb-0 mt-1">Able Pro</h5>
                        <p>Checkout pro features</p>
                        <a href="https://themeforest.net/item/able-pro-bootstrap-admin-dashboard-template/50170229"
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <div class="avtar avtar-s border bg-light-primary"
                                                    data-bs-toggle="tooltip" data-bs-title="143 Posts"><span>MD</span>
                                                </div>
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                                <div class="row g-1">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <div class="avtar avtar-s border bg-light-warning"
                                                    data-bs-toggle="tooltip" data-bs-title="143 Posts"><span>OC</span>
                                                </div>
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                                <div class="row g-1">
