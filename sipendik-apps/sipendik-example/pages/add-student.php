  ...
  <div class="col-9">
    <div class="card rounded-0 p-2">
      <div class="card-body">
        ...
        <form action="config/crud.php?aksi=create-student" method="post" enctype="multipart/form-data">
          ...
          <div class="row mb-2 align-items-center">
            <label for="nama_siswa" class="col-3 form-label">Full Name</label>
            <div class="col-9">
              <input class="form-control form-control-sm" type="text" name="nama_siswa" required>
            </div>
          </div>
          <div class="row mb-2">
